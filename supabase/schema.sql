...
create table if not exists public.costco_vision_candidates (
  ...
  product_name text, brand text, costco_item_number text, jan text,
  package_quantity numeric, package_unit text,
  observed_price_jpy numeric, regular_price_jpy numeric, sale_price_jpy numeric,
  sale_evidence text, sale_end_date date, confidence numeric,
...
create table if not exists public.costco_photo_pairings (
  ...
  method text not null default 'candidate', score numeric,
